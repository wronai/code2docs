...
|--------|-----------|---------|----------|
| `__main__` | 0/0 | 0/0 | 🟢 100% |
| `analyzers` | 0/0 | 0/0 | 🟢 100% |
| `analyzers.dependency_scanner` | 0/0 | 3/3 | 🟢 100% |
| `analyzers.docstring_extractor` | 0/0 | 2/2 | 🟢 100% |
| `analyzers.endpoint_detector` | 0/0 | 2/2 | 🟢 100% |
| `analyzers.project_scanner` | 1/1 | 1/1 | 🟢 100% |
| `base` | 0/0 | 2/2 | 🟢 100% |
| `cli` | 13/13 | 1/1 | 🟢 100% |
...
| `generators.depgraph_gen` | 0/0 | 1/1 | 🟢 100% |
| `generators.examples_gen` | 0/0 | 1/1 | 🟢 100% |
...
| `sync` | 0/0 | 0/0 | 🟢 100% |
| `sync.differ` | 0/0 | 2/2 | 🟢 100% |
| `sync.updater` | 0/0 | 1/1 | 🟢 100% |
| `sync.watcher` | 1/1 | 0/0 | 🟢 100% |
