...
![version](https://img.shields.io/badge/version-0.1.0-blue) ![python](https://img.shields.io/badge/python-%3E%3D3.9-blue) ![coverage](https://img.shields.io/badge/coverage-unknown-lightgrey) ![functions](https://img.shields.io/badge/functions-351-green)
> **351** functions | **60** classes | **55** files | CC̄ = 3.6
...
```
code2docs/
├── project        ├── advanced_usage        ├── quickstart    ├── registry    ├── base├── code2docs/    ├── __main__        ├── updater    ├── sync/        ├── watcher        ├── differ        ├── quickstart        ├── advanced_usage        ├── markdown        ├── badges        ├── toc    ├── formatters/        ├── readme_gen    ├── cli        ├── _source_links        ├── coverage_gen        ├── depgraph_gen        ├── getting_started_gen        ├── config_docs_gen    ├── generators/        ├── changelog_gen        ├── code2llm_gen        ├── module_docs_gen        ├── org_readme_gen        ├── api_reference_gen        ├── mkdocs_gen    ├── config        ├── _registry_adapters        ├── examples_gen        ├── contributing_gen        ├── architecture_gen    ├── analyzers/        ├── api_changelog_gen        ├── endpoint_detector        ├── project_scanner    ├── 04_sync_and_watch    ├── 05_custom_generators    ├── quickstart    ├── 06_formatters    ├── advanced_usage    ├── 03_programmatic_api    ├── entry_points    ├── 07_web_frameworks    ├── basic_usage    ├── 01_cli_usage    ├── 02_configuration        ├── docstring_extractor        ├── dependency_scanner    ├── llm_helper```
...
```
code2docs/
├── project        ├── quickstart        ├── advanced_usage    ├── registry    ├── base├── code2docs/    ├── __main__        ├── updater    ├── sync/        ├── watcher        ├── differ        ├── quickstart        ├── advanced_usage        ├── markdown        ├── badges        ├── toc    ├── formatters/        ├── readme_gen        ├── coverage_gen        ├── _source_links        ├── depgraph_gen    ├── cli        ├── config_docs_gen        ├── getting_started_gen    ├── generators/        ├── code2llm_gen        ├── changelog_gen        ├── module_docs_gen        ├── org_readme_gen        ├── api_reference_gen        ├── mkdocs_gen        ├── examples_gen    ├── config        ├── _registry_adapters        ├── architecture_gen        ├── api_changelog_gen    ├── analyzers/        ├── contributing_gen        ├── dependency_scanner        ├── project_scanner    ├── 04_sync_and_watch    ├── 05_custom_generators    ├── quickstart    ├── 06_formatters    ├── advanced_usage    ├── 03_programmatic_api    ├── entry_points    ├── 07_web_frameworks    ├── basic_usage    ├── 01_cli_usage    ├── 02_configuration        ├── endpoint_detector        ├── docstring_extractor    ├── llm_helper```
...
```
code2docs/
├── project        ├── quickstart        ├── advanced_usage    ├── registry    ├── base├── code2docs/    ├── __main__        ├── updater    ├── sync/        ├── watcher        ├── differ        ├── quickstart        ├── advanced_usage        ├── markdown        ├── badges        ├── toc    ├── formatters/        ├── readme_gen        ├── coverage_gen        ├── _source_links        ├── depgraph_gen        ├── getting_started_gen        ├── config_docs_gen    ├── cli        ├── changelog_gen    ├── generators/        ├── code2llm_gen        ├── module_docs_gen        ├── org_readme_gen        ├── api_reference_gen        ├── mkdocs_gen        ├── examples_gen        ├── _registry_adapters    ├── config        ├── api_changelog_gen        ├── contributing_gen    ├── analyzers/        ├── architecture_gen        ├── docstring_extractor        ├── project_scanner    ├── 04_sync_and_watch    ├── 05_custom_generators    ├── quickstart    ├── 06_formatters    ├── advanced_usage    ├── 03_programmatic_api    ├── entry_points    ├── 07_web_frameworks    ├── basic_usage    ├── 01_cli_usage    ├── 02_configuration        ├── dependency_scanner        ├── endpoint_detector    ├── llm_helper```
...
📄 `code2docs.generators.mkdocs_gen` (5 functions, 1 classes)
📄 `code2docs.generators.module_docs_gen` (13 functions, 1 classes)
...
```
code2docs/
├── project        ├── advanced_usage        ├── quickstart    ├── registry    ├── base├── code2docs/    ├── __main__        ├── updater    ├── sync/        ├── watcher        ├── differ        ├── quickstart        ├── advanced_usage        ├── markdown        ├── badges        ├── toc    ├── formatters/        ├── readme_gen    ├── cli        ├── _source_links        ├── coverage_gen        ├── depgraph_gen        ├── config_docs_gen        ├── getting_started_gen    ├── generators/        ├── code2llm_gen        ├── changelog_gen        ├── module_docs_gen    ├── config        ├── org_readme_gen        ├── mkdocs_gen        ├── api_reference_gen        ├── api_changelog_gen        ├── architecture_gen        ├── contributing_gen        ├── examples_gen    ├── analyzers/        ├── _registry_adapters        ├── docstring_extractor        ├── project_scanner    ├── 04_sync_and_watch    ├── 05_custom_generators    ├── quickstart    ├── 06_formatters    ├── advanced_usage    ├── 03_programmatic_api    ├── entry_points    ├── 07_web_frameworks    ├── basic_usage    ├── 01_cli_usage    ├── 02_configuration        ├── dependency_scanner        ├── endpoint_detector    ├── llm_helper```
...
```
code2docs/
├── project        ├── quickstart        ├── advanced_usage    ├── registry    ├── base├── code2docs/    ├── __main__        ├── updater    ├── sync/        ├── watcher        ├── differ        ├── quickstart        ├── advanced_usage        ├── markdown        ├── badges        ├── toc    ├── formatters/        ├── readme_gen        ├── coverage_gen        ├── _source_links        ├── depgraph_gen        ├── getting_started_gen    ├── cli        ├── config_docs_gen    ├── generators/        ├── code2llm_gen        ├── module_docs_gen        ├── changelog_gen        ├── org_readme_gen        ├── api_reference_gen        ├── mkdocs_gen        ├── examples_gen        ├── _registry_adapters    ├── config        ├── contributing_gen        ├── api_changelog_gen    ├── analyzers/        ├── architecture_gen        ├── dependency_scanner        ├── project_scanner    ├── 04_sync_and_watch    ├── 05_custom_generators    ├── quickstart    ├── 06_formatters    ├── advanced_usage    ├── 03_programmatic_api    ├── entry_points    ├── 07_web_frameworks    ├── class_examples    ├── basic_usage    ├── 01_cli_usage    ├── 02_configuration        ├── docstring_extractor        ├── endpoint_detector    ├── llm_helper```
...
```
code2docs/
├── project        ├── quickstart    ├── registry    ├── base├── code2docs/    ├── __main__        ├── updater    ├── sync/        ├── watcher        ├── differ        ├── quickstart        ├── advanced_usage        ├── markdown        ├── badges        ├── toc    ├── formatters/        ├── readme_gen        ├── coverage_gen        ├── _source_links        ├── depgraph_gen        ├── getting_started_gen    ├── cli        ├── config_docs_gen    ├── generators/        ├── code2llm_gen        ├── module_docs_gen        ├── changelog_gen        ├── org_readme_gen        ├── api_reference_gen        ├── mkdocs_gen        ├── examples_gen        ├── _registry_adapters    ├── config        ├── contributing_gen        ├── api_changelog_gen    ├── analyzers/        ├── architecture_gen        ├── dependency_scanner        ├── project_scanner    ├── 04_sync_and_watch    ├── 05_custom_generators    ├── quickstart    ├── 06_formatters    ├── advanced_usage    ├── 03_programmatic_api    ├── entry_points    ├── 07_web_frameworks    ├── class_examples    ├── basic_usage    ├── 01_cli_usage    ├── 02_configuration        ├── docstring_extractor        ├── endpoint_detector    ├── llm_helper```
...
```
code2docs/
├── project        ├── quickstart    ├── registry    ├── base├── code2docs/    ├── __main__        ├── updater    ├── sync/        ├── watcher        ├── differ        ├── quickstart        ├── advanced_usage        ├── markdown        ├── badges        ├── toc    ├── formatters/        ├── readme_gen        ├── coverage_gen        ├── _source_links    ├── cli        ├── depgraph_gen        ├── config_docs_gen        ├── getting_started_gen    ├── generators/        ├── changelog_gen        ├── code2llm_gen        ├── org_readme_gen        ├── module_docs_gen        ├── api_reference_gen        ├── mkdocs_gen        ├── examples_gen        ├── api_changelog_gen    ├── config        ├── architecture_gen        ├── contributing_gen    ├── analyzers/        ├── _registry_adapters        ├── docstring_extractor        ├── project_scanner    ├── 04_sync_and_watch    ├── 05_custom_generators    ├── quickstart    ├── 06_formatters    ├── advanced_usage    ├── 03_programmatic_api    ├── entry_points    ├── 07_web_frameworks    ├── class_examples    ├── basic_usage    ├── 01_cli_usage    ├── 02_configuration        ├── dependency_scanner        ├── endpoint_detector    ├── llm_helper```
...
```
code2docs/
    ├── registry    ├── base├── code2docs/    ├── __main__    ├── 04_sync_and_watch    ├── 05_custom_generators    ├── quickstart    ├── 06_formatters    ├── advanced_usage    ├── 03_programmatic_api    ├── entry_points    ├── 07_web_frameworks    ├── class_examples    ├── basic_usage    ├── 01_cli_usage    ├── 02_configuration        ├── updater    ├── sync/        ├── watcher        ├── differ        ├── quickstart        ├── advanced_usage        ├── markdown        ├── badges        ├── toc    ├── formatters/        ├── readme_gen    ├── cli        ├── _source_links        ├── coverage_gen        ├── getting_started_gen        ├── depgraph_gen        ├── config_docs_gen    ├── generators/        ├── code2llm_gen        ├── changelog_gen        ├── module_docs_gen        ├── org_readme_gen    ├── config        ├── mkdocs_gen        ├── api_reference_gen        ├── api_changelog_gen        ├── architecture_gen        ├── examples_gen        ├── contributing_gen    ├── analyzers/        ├── _registry_adapters        ├── endpoint_detector        ├── project_scanner        ├── quickstart├── project        ├── docstring_extractor        ├── dependency_scanner    ├── llm_helper```
